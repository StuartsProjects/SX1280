...
{
  int32_t error;
  error = SX1280LT.getFrequencyErrorRegValue();
  Serial.print(F("Frequency error register 0x"));
  Serial.println(error, HEX);
  error = SX1280LT.getFrequencyErrorHz();
  Serial.print(F("Hertz error "));
  Serial.print(error);
  Serial.println(F("hz"));
}
...
void setup(void)
{
  ...
  Serial.println();
  Serial.println();
  Serial.println(F("6_SX1280LT_LoRa_RX_Frequency_Error_Check Starting"));
  Serial.println();
