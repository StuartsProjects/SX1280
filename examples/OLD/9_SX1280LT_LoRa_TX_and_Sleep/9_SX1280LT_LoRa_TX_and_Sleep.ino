...
******************************************************************************************************
  ...
  A packet is sent and the SX1280 is put to sleep with register values retained. It should then be
...
bool Send_Test_Packet()
{
  ...
  if (SX1280LT.sendPacketLoRa(buff, bufffersize, 1000, TestPower, DIO1))
  {
    return true;
  }
  else
