...
void loop()
{
  ...
  else
  {
    ...
    delay(250);                                                     //wait for potential packet to trigger set IRQs
...
void setup_RangingRX()
{
  ...
  SX1280LT.setRangingRangingAddress(TXaddress);
  ...
  SX1280LT.setRangingRole(RADIO_RANGING_ROLE_SLAVE);
...
void setup()
{
  ...
  Serial.println("10_SX1280LT Ranging Receiver Starting");
