...
uint16_t const CalibrationStart = 9500;          //calibration value for ranging, SF10, BW400      
uint16_t const CalibrationEnd = 10700;           //calibration value for ranging, SF10, BW400
